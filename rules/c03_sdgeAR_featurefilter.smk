...
rule c03_sdgeAR_featurefilter:
    ...
    run:
        ...
        # sdgeAR_ftr_tabqc_unzip = output.sdgeAR_ftr_tabqc.replace(".gz", "")
        shell(
        r"""
        set -euo pipefail
        {params.module_cmd}
        ...
        command time -v {python} {novascope_scripts}/rule_c03.feature_filter.py --input {input.sdgeAR_ftr_tab} --output {output.sdgeAR_ftr_tabqc}  {gtype_args} {gname_args} {gct_args}
        """
        )