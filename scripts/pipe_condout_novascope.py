...
def outfn_filterpoly_per_unit(main_dirs, df_segchar):
    ...
    out_fn = {
            ...
            'root': main_dirs["analysis"],
            'subfolders_patterns': [
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.transcripts.tsv.gz"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.transcripts.tsv.gz.tbi"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.coordinate_minmax.tsv"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.feature.strict.tsv.gz"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.boundary.strict.geojson"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.feature.lenient.tsv.gz"], None),
                    (["{run_id}", "{unit_id}", "preprocess", "{unit_id}.{solo_feature}.filtered.boundary.lenient.geojson"], None),
            ],
            'zip_args': {
...
def outfnlist_by_seg(main_dirs, df_segchar):
    outfnlist = [
    outfn_filterpoly_per_unit(main_dirs, df_segchar),
    outfn_seg10x_per_unit(main_dirs, df_segchar),
    outfn_segfict_per_unit(main_dirs, df_segchar),]
    return outfnlist